...
public class Query {
    ...
    public static int update_bal(int new_amount, Account b2) {
        ...
        try {
            ...
            String q = (String.format("UPDATE netbanking SET balance=%d where account_id=%d ;", new_amount,acc) );
        ...
        b2.setAccount_balance(new_amount);
